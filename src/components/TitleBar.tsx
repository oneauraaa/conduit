...
/**
 * Replaces the native macOS title bar. The window is `decorations: false`, so
 * the traffic lights are gone and this strip provides both the drag region and
  ...
  return (
    ...
    >
      <button
        ...
        aria-label="Hide conduit to the menu bar"
        title="Hide to menu bar — conduit keeps running"
